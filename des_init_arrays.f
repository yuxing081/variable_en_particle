...
! Store the particle imformation last time-step
      DES_POS_OLD_Eu(LB:UB,:) = ZERO
      DES_VEL_OLD_Eu(LB:UB,:) = ZERO
      OMEGA_OLD_Eu(LB:UB,:) = ZERO
      CLOSEST_PT_OLD(LB:UB,:) = ZERO
      EN_Var(LB:UB) = ZERO
...
END MODULE DES_INIT_ARRAYS_MOD
